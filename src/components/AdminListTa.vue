...
<script>
  ...
  export default {
    ...
    methods: {
      initialize () {
        axios.get('https://srv.5degeneve.ch/api/travel_agencies')
      ...
      confirm (event) {
        ...
        axios.post('https://srv.5degeneve.ch/api/ta_update',{data})
        .then(response => (axios.get('https://srv.5degeneve.ch/api/travel_agencies')
        .then(response => (this.agencies = response.data,console.log(response.data)))
        .catch(error => console.log(error))))
        .catch(error => (console.log(error)))
      },
